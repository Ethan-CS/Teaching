...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Further exercises (Polymorphism)
		BankAccount b = new SavingsAccount(p, 0.05);
		
		//SavingsAccount sa = new BankAccount(p); // Doesn't work (gives an error)
		//b.addInterest(); // Also doesn't work!
		
		System.out.println(b.toString()); // Calls the toString from SavingsAccount
